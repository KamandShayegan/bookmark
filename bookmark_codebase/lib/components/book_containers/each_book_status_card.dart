...
class EachBookStatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        showDialog(context: context, builder: (_)=>AddComment());
      },
      child: Container(
              ...
              children: [
                const SizedBox(
                  ...
                  _setSVG(readingStatus),
                        ...
                        height: (readingStatus == ReadingStatus.readBefore)?22: 24,
                      ),
                      const SizedBox(
                        width: 8,
                      ),
  ...
  String _setSVG(ReadingStatus readingStatus) {
    ...
    SvgPaths.feather:(readingStatus == ReadingStatus.goingToRead)?SvgPaths.inbox:SvgPaths.archive;
  }
}
