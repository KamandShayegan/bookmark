          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const EachBookStatusCard(numberOfBooks: 10, readingStatus: ReadingStatus.isReading),
                const EachBookStatusCard(numberOfBooks: 10, readingStatus: ReadingStatus.goingToRead),
                const EachBookStatusCard(numberOfBooks: 10, readingStatus: ReadingStatus.readBefore),
