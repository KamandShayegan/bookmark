...
SearchResultWithoutBookList searchResulWithoutBookListtFromJson(String str) =>
    SearchResultWithoutBookList.fromJson(json.decode(str));

String searchResultWithoutBookListToJson(SearchResultWithoutBookList data) => json.encode(data.toJson());

class SearchResultWithoutBookList {
  SearchResultWithoutBookList({
  ...
  factory SearchResultWithoutBookList.fromJson(Map<String, dynamic> json) => SearchResultWithoutBookList(
